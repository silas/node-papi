...
Client.prototype._request = function(opts) {
  ...
  var i = 0;
  function next(err) {
    if (err) return ctx._callback(self._err(err, opts), ctx.res);
...
Client.prototype.__create = function(ctx, next) {
  ...
  if (opts.body !== undefined) {
    ...
    var isStream = body instanceof stream.Readable;
